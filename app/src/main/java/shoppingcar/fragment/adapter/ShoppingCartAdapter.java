package shoppingcar.fragment.adapter;
...
import shoppingcar.fragment.view.AddSubView;
...
public class ShoppingCartAdapter extends RecyclerView.Adapter<ShoppingCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Glide.with(mContext).load(Constans.BASE_URL_IMAGE + goodsBean.getFigure()).into(holder.iv_gov);
